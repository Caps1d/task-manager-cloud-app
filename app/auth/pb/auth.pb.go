...
var file_auth_pb_auth_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x40, 0x0a, 0x10, 0x52,
...
func file_auth_pb_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_auth_pb_auth_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_auth_pb_auth_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_auth_pb_auth_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_auth_pb_auth_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_auth_pb_auth_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_auth_pb_auth_proto_msgTypes[5].Exporter = func(v any, i int) any {
